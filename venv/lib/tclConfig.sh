...
# installed.
TCL_PREFIX='/Users/user/ML_course/4th_month/wrapped/venv'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Users/user/ML_course/4th_month/wrapped/venv'
...
TCL_EXTRA_CFLAGS='-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /Users/user/ML_course/4th_month/wrapped/venv/include -fdebug-prefix-map=/var/folders/sy/f16zz6x50xz3113nwtb9bvq00000gp/T/abs_57xzmki7k8/croot/tk_1748849401630/work=/usr/local/src/conda/tk-8.6.14 -fdebug-prefix-map=/Users/user/ML_course/4th_month/wrapped/venv=/usr/local/src/conda-prefix -pipe  -arch x86_64 -D_FORTIFY_SOURCE=2 -isystem /Users/user/ML_course/4th_month/wrapped/venv/include -mmacosx-version-min=10.15 '
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Users/user/ML_course/4th_month/wrapped/venv/lib -L/Users/user/ML_course/4th_month/wrapped/venv/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Users/user/ML_course/4th_month/wrapped/venv/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Users/user/ML_course/4th_month/wrapped/venv/include'
...
TCL_PACKAGE_PATH='{/Users/user/ML_course/4th_month/wrapped/venv/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Users/user/ML_course/4th_month/wrapped/venv/lib -ltclstub8.6'
...
TCL_STUB_LIB_PATH='/Users/user/ML_course/4th_month/wrapped/venv/lib/libtclstub8.6.a'
